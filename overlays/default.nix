...
in
{
  ...
  pi-coding-agent =
    ...
    prev.pi-coding-agent.overrideAttrs (old: {
      ...
      # v0.82.0 externalized model data: *.models.ts imports from ./data/<provider>.json.
      ...
      # v0.82.0 also imports ./data/.manifest.json -> stub that too.
      preBuild = (old.preBuild or "") + ''
        ...
        # Create stub .manifest.json (generated by scripts/generate-models.ts)
        if [ ! -f packages/ai/src/providers/data/.manifest.json ]; then
          echo '{"schemaVersion":1,"generatedAt":"1970-01-01T00:00:00.000Z","structureHash":"stub","files":{}}' > packages/ai/src/providers/data/.manifest.json
        fi
