{
  inputs = {
    ...
    nixpkgs-desktop-kernel = {
      url = "github:pongo1231/nixpkgs/41c096f9400b72cce3eed1e233c252452c287ece";
      #follows = "nixpkgs";
    };
    ...
    nixpkgs-jupiter-kernel.url = "github:nixos/nixpkgs/41c096f9400b72cce3eed1e233c252452c287ece";
