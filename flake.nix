{
  inputs = {
    ...
    nixpkgs-desktop-kernel = {
      url = "github:pongo1231/nixpkgs/66676a8096a251cf53f4b3ae38a7422e793e3db5";
      #follows = "nixpkgs";
    };
    ...
    #nixpkgs-jupiter-kernel.url = "github:nixos/nixpkgs/66676a8096a251cf53f4b3ae38a7422e793e3db5";
