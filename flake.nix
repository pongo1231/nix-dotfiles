{
  inputs = {
    ...
    nixpkgs-desktop-kernel = {
      url = "github:pongo1231/nixpkgs/386ec507d8677856a332fb88104fab60e4e6c60d";
      #follows = "nixpkgs";
    };
    ...
    #nixpkgs-jupiter-kernel.url = "github:nixos/nixpkgs/386ec507d8677856a332fb88104fab60e4e6c60d";
