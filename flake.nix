{
  inputs = {
    ...
    nixpkgs-desktop-kernel = {
      url = "github:pongo1231/nixpkgs/6db187ba60ee21b98f1ab6ebf38d466bc5690f0c";
      #follows = "nixpkgs";
    };
    ...
    #nixpkgs-jupiter-kernel.url = "github:nixos/nixpkgs/6db187ba60ee21b98f1ab6ebf38d466bc5690f0c";
