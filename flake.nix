{
  inputs = {
    ...
    nixpkgs-desktop-kernel = {
      url = "github:pongo1231/nixpkgs/a2e94a7006c6532c920dc156505565b684c19de2";
      #follows = "nixpkgs";
    };
    ...
    #nixpkgs-jupiter-kernel.url = "github:nixos/nixpkgs/a2e94a7006c6532c920dc156505565b684c19de2";
