{
  inputs = {
    ...
    nixpkgs-desktop-kernel = {
      url = "github:pongo1231/nixpkgs/e6b5e795bf244393f942987b41f48bb37879b773";
      #follows = "nixpkgs";
    };
    ...
    nixpkgs-jupiter-kernel.url = "github:nixos/nixpkgs/e6b5e795bf244393f942987b41f48bb37879b773";
