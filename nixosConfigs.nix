  ...
  commonSystem =
    ...
    lib.nixosSystem {
      ...
      modules =
        ...
        ++ lib.optionals (type != null) builtins.trace (builtins.toString (specialArgs.modules /${type} { includeModulesInPath = true; })) (specialArgs.modules /${type} { includeModulesInPath = true; })
